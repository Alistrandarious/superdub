...
// ── Core Habits Matrix — the daily tracking loops, as illuminating tokens.
...
// Tracker status uses the logging day (2 AM boundary); the check-in ISO stays on
// the real calendar day to match the server-stamped check-in date.
  ...
  return (
    <div className="chm">
      <div className="chm-head">
        ...
        <span className="chm-count">{doneCount}/{slots.length} today</span>
      </div>
