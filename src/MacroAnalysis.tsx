...
const MACRO_COLORS: Record<MacroKey, string> = { protein: '#ff6ec7', carbs: '#2E8BFF', fats: '#ffd60a' };
            ...
            <div className="pie-wrap">
              <ResponsiveContainer width="100%" height={200}>
                <PieChart>
                  ...
                  <Tooltip formatter={(val) => [`${val} kcal`, '']} contentStyle={{ background: '#0e1022', border: '1px solid #1e2245', color: '#2E8BFF', borderRadius: 10 }} />
                </PieChart>
              </ResponsiveContainer>
            </div>
